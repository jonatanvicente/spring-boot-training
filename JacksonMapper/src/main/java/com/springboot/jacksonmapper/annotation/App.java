...
import com.springboot.jacksonmapper.annotation.bidirection.ItemWithIdentity;
import com.springboot.jacksonmapper.annotation.bidirection.ItemWithRef;
import com.springboot.jacksonmapper.annotation.bidirection.UserWithIdentity;
import com.springboot.jacksonmapper.annotation.bidirection.UserWithRef;
import com.springboot.jacksonmapper.annotation.date.EventWithFormat;
import com.springboot.jacksonmapper.annotation.date.EventWithSerializer;
import com.springboot.jacksonmapper.annotation.dtos.withEnum.DistanceEnumWithValue;
import com.springboot.jacksonmapper.annotation.exception.UserWithRoot;
import com.springboot.jacksonmapper.annotation.exception.UserWithRootNamespace;
import com.springboot.jacksonmapper.annotation.ignore.MyMixInForIgnoreType;
import com.springboot.jacksonmapper.annotation.jsonview.Item;
import com.springboot.jacksonmapper.annotation.jsonview.Views;
...
public class App {
    ...
    public void whenSerializingUsingMixInAnnotation_thenCorrect() throws JsonProcessingException {
        final com.springboot.jacksonmapper.annotation.dtos.Item item = new com.springboot.jacksonmapper.annotation.dtos.Item(1, "book", null);

        String result = new ObjectMapper().writeValueAsString(item);
        System.out.println(result);

        final ObjectMapper mapper = new ObjectMapper();
        mapper.addMixIn(com.springboot.jacksonmapper.annotation.dtos.User.class, MyMixInForIgnoreType.class);
